...
public class Map2dGrid : MonoBehaviour
{
    ...
    public void GridGen(){
            ...
            Line.transform.localScale = new Vector3(widht, transform.localScale.y, 1f);
            Line.transform.position = new Vector3(0, transform.localScale.y /2, 1f);
            ...
            for(float i = 0; i < transform.localScale.x / CellSize; i ++){
                ...
                GameObject LineY = Instantiate(Line,new Vector3(transform.position.x,(i * CellSize - Map.transform.localScale.y / 2 ),transform.position.z + 1),Quaternion.Euler(0,0,90),Grid.transform);
                LineX.transform.localScale = new Vector3(widht, transform.localScale.y, 1f);
                LineY.transform.localScale = new Vector3(widht, transform.localScale.x, 1f);
            }
    }
